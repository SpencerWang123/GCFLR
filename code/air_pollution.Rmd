...
res_city_2021_lad=parLapply(cl,(1:50),city_2021,method="hl")
...
p=4
########
hl_dir=dir("F:/iCloudDrive/Project/聚类回归文章/数据部分/模拟数据-气象数据/sim_2021/hl")
nf=length(hl_dir)
hl_label_BIC=NULL
hl_label_eBIC=NULL
K_seq_BIC=NULL
...
for (i in 1:length(hl_dir)) 
{
load(paste("F:/iCloudDrive/Project/聚类回归文章/数据部分/模拟数据-气象数据/sim_2021/hl/",hl_dir[i],sep = ""))
K_seq_BIC=c(K_seq_BIC,temp_res$K_BIC)
K_seq_eBIC=c(K_seq_eBIC,temp_res$K_eBIC)
hl_label_BIC=c(hl_label_BIC,as.numeric(temp_res$selected_res_BIC$labels[[1]]))
hl_label_eBIC=c(hl_label_eBIC,as.numeric(temp_res$selected_res_eBIC$labels[[1]]))
...
hl_fd_BIC=demand_fd_BIC
hl_fd_eBIC=demand_fd_eBIC
hl_k_BIC=K_seq_BIC
hl_k_eBIC=K_seq_eBIC
#########ls
########
...
#plot(hl_fd_BIC,xlim=c(0,7500),ylim = c(-0.0003,0.00035),main="HL-BIC")
plot(lad_fd_BIC,xlim=c(0,7500),ylim = c(-0.0003,0.00035),cex.axis=1.2,cex.lab=1.5,cex.main=1.5,main="CFLR-BIC(LAD)")
#plot(gibbs_fd_BIC_ls,xlim=c(0,7500),ylim = c(-0.0003,0.00035),main="Gibbs-LS-BIC")
#plot(gibbs_fd_BIC_lad,xlim=c(0,7500),ylim = c(-0.0003,0.00035),main="Gibbs-LAD-BIC")
#plot(hl_fd_eBIC,xlim=c(0,7500),ylim = c(-0.0003,0.00035),main="HL-eBIC")
...
k_df=rbind(table(ls_k_BIC),table(hl_k_BIC),table(lad_k_BIC),table(gibbs_ls_k_BIC),table(gibbs_lad_k_BIC),
           table(ls_k_eBIC),table(hl_k_eBIC),table(lad_k_eBIC),table(gibbs_ls_k_eBIC),table(gibbs_lad_k_eBIC))
rownames(k_df)=c("LS_BIC","HL_BIC","LAD_BIC","Gibbs_LS_BIC","Gibbs_LAD_BIC",
                 "LS_eBIC","HL_eBIC","LAD_eBIC","Gibbs_LS_eBIC","Gibbs_LAD_eBIC")
#write.csv(k_df,"/Users/wangzhen/Library/Mobile Documents/com~apple~CloudDocs/Project/函数型数据回归聚类/city_k_df_0726.csv")
k_df
...
for (j in (1:M)[-i])
{
  ...
  ari_seq_hl_BIC=c(ari_seq_hl_BIC,compare(label_2021_hl_BIC[,i],label_2021_hl_BIC[,j],method="adjusted.rand"))
  ...
  ari_seq_hl_eBIC=c(ari_seq_hl_eBIC,compare(label_2021_hl_eBIC[,i],label_2021_hl_eBIC[,j],method="adjusted.rand"))
  ari_seq_lad_eBIC=c(ari_seq_lad_eBIC,compare(label_2021_lad_eBIC[,i],label_2021_lad_eBIC[,j],method="adjusted.rand"))
}  
}


ari_df=data.frame(LS_BIC=ari_seq_ls_BIC,HL_BIC=ari_seq_hl_BIC,LAD_BIC=ari_seq_lad_BIC,
                  Gibbs_LS_BIC=ari_seq_gibbs_ls_BIC,Gibbs_LAD_BIC=ari_seq_gibbs_lad_BIC,
                  LS_eBIC=ari_seq_ls_eBIC,HL_eBIC=ari_seq_hl_eBIC,LAD_eBIC=ari_seq_lad_eBIC,
                  Gibbs_LS_eBIC=ari_seq_gibbs_ls_eBIC,Gibbs_LAD_eBIC=ari_seq_gibbs_lad_eBIC)
ari_df_BIC=data.frame(LS=ari_seq_ls_BIC,HL=ari_seq_hl_BIC,LAD=ari_seq_lad_BIC,
                  Gibbs_LS=ari_seq_gibbs_ls_BIC,Gibbs_LAD=ari_seq_gibbs_lad_BIC)
ari_df_eBIC=data.frame(LS=ari_seq_ls_eBIC,HL=ari_seq_hl_eBIC,LAD=ari_seq_lad_eBIC,
...
#write.csv(ari_df,"/Users/wangzhen/Library/Mobile Documents/com~apple~CloudDocs/Project/函数型数据回归聚类/ari_record_air_pollution_BIC.csv")
#write.csv(label_2021_ls_BIC,"/Users/wangzhen/Library/Mobile Documents/com~apple~CloudDocs/Project/函数型数据回归聚类/label_ls_air_pollution_BIC.csv")
#write.csv(label_2021_hl_BIC,"/Users/wangzhen/Library/Mobile Documents/com~apple~CloudDocs/Project/函数型数据回归聚类/label_hl_air_pollution_BIC.csv")
#write.csv(label_2021_lad_BIC,"/Users/wangzhen/Library/Mobile Documents/com~apple~CloudDocs/Project/函数型数据回归聚类/label_lad_air_pollution_BIC.csv")
#write.csv(label_gibbs_ls_BIC,"/Users/wangzhen/Library/Mobile Documents/com~apple~CloudDocs/Project/函数型数据回归聚类/label_gibbs_ls_air_pollution_BIC.csv")
#write.csv(label_gibbs_lad_BIC,"/Users/wangzhen/Library/Mobile Documents/com~apple~CloudDocs/Project/函数型数据回归聚类/label_gibbs_lad_air_pollution_BIC.csv")

#write.csv(label_2021_ls_eBIC,"/Users/wangzhen/Library/Mobile Documents/com~apple~CloudDocs/Project/函数型数据回归聚类/label_ls_air_pollution_eBIC.csv")
#write.csv(label_2021_hl_eBIC,"/Users/wangzhen/Library/Mobile Documents/com~apple~CloudDocs/Project/函数型数据回归聚类/label_hl_air_pollution_eBIC.csv")
#write.csv(label_2021_lad_eBIC,"/Users/wangzhen/Library/Mobile Documents/com~apple~CloudDocs/Project/函数型数据回归聚类/label_lad_air_pollution_eBIC.csv")
#write.csv(label_gibbs_ls_eBIC,"/Users/wangzhen/Library/Mobile Documents/com~apple~CloudDocs/Project/函数型数据回归聚类/label_gibbs_ls_air_pollution_eBIC.csv")
#write.csv(label_gibbs_lad_eBIC,"/Users/wangzhen/Library/Mobile Documents/com~apple~CloudDocs/Project/函数型数据回归聚类/label_gibbs_lad_air_pollution_eBIC.csv")
