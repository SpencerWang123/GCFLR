...
## parallel algorithm for example 4
```{r}
...
parLapply(cl,1:50,parallel_simulation4,method="lad",type=c(TRUE,TRUE),NN=50)
parLapply(cl,c(1:50),parallel_simulation4,method="ls",type=c(TRUE,TRUE),NN=50)
...
empty_mse_eBIC_seq=vector("list",2)#mse_seq
empty_ari_BIC_seq=NULL
empty_ari_eBIC_seq=NULL#mse_seq
#######################stability indicated by ARI
empty_label_record_BIC=vector("list",2)
empty_label_record_eBIC=vector("list",2)
