...
## parallel algorithm for example 3
```{r}
...
empty_mse1_BIC=c(list(rep(0,6)),list(rep(0,6)))#mse
empty_mse1_eBIC=c(list(rep(0,6)),list(rep(0,6)))#mse
empty_mse2_BIC=c(list(rep(0,6)),list(rep(0,6)))#mse
empty_mse2_eBIC=c(list(rep(0,6)),list(rep(0,6)))#mse
