...
#
reg_coef_df=matrix(c(rep(1,N),rep(0.5,N/2),rep(-0.5,N/2)),ncol = 2)
...
parLapply(cl,1:50,parallel_simulation1,method="lad",type=c(TRUE,TRUE))
parLapply(cl,51:60,parallel_simulation1,method="ls",type=c(TRUE,TRUE))
parLapply(cl,1:50,parallel_simulation1,method="hl",type=c(FALSE,TRUE))
1
```
...
real_beta_function1_1=function(x){return(fun_1(x)+0.5*fun_2(x))}
real_beta_function1_2=function(x){return(fun_1(x)-0.5*fun_2(x))}
